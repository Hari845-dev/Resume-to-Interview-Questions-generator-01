...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FBF9F5] text-slate-900 selection:bg-violet-200 selection:text-violet-900">
      {/* Navigation Header */}
      <header className="sticky top-0 z-40 bg-[#FBF9F5]/90 backdrop-blur-md border-b border-slate-200/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
            ...
            <button
              onClick={() => scrollToSection('why-grounding')}
              className="hover:text-violet-700 transition-colors"
            >
              Why InterviewAI
            </button>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-5 py-2.5 text-sm font-semibold text-white bg-slate-900 hover:bg-violet-700 rounded-xl shadow-sm transition-all duration-200 flex items-center gap-2 group"
            >
      ...
      <section className="pt-16 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <button
            onClick={handleGetStarted}
            className="w-full sm:w-auto px-8 py-4 text-base font-bold text-white bg-slate-900 hover:bg-violet-700 rounded-2xl shadow-xl shadow-slate-900/10 transition-all duration-200 flex items-center justify-center gap-3 group"
          >
          ...
          <button
            onClick={() => scrollToSection('how-it-works')}
            className="w-full sm:w-auto px-7 py-4 text-base font-semibold text-slate-700 bg-white hover:bg-slate-50 border border-slate-300/80 rounded-2xl shadow-sm transition-colors flex items-center justify-center gap-2"
          >
        ...
        <div className="relative max-w-5xl mx-auto rounded-3xl border border-slate-800 bg-[#0B1120] text-slate-200 shadow-2xl p-4 sm:p-6 md:p-8 text-left overflow-hidden">
          {/* Subtle Glows */}
          ...
          <div className="bg-slate-900/90 rounded-2xl border border-slate-800 p-5 sm:p-6 relative">
            ...
            <div className="mt-4 pt-4 border-t border-slate-800">
              <button
                ...
                className="w-full flex items-center justify-between text-xs font-semibold uppercase tracking-wider text-violet-400 hover:text-violet-300 transition-colors"
              >
            ...
            <div className="mt-5 p-3 sm:p-4 rounded-xl bg-slate-950/70 border border-slate-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              ...
              <button
                onClick={handleGetStarted}
                className="px-4 py-2 rounded-lg bg-violet-600 hover:bg-violet-500 text-white font-semibold text-xs transition-colors shrink-0 flex items-center gap-1.5"
              >
      ...
      {/* Product Story Pipeline Section */}
      <section id="pipeline" className="py-20 bg-white border-y border-slate-200/80">
      ...
      <section id="why-grounding" className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-[#0B1120] text-white p-6 sm:p-8 rounded-3xl border border-slate-800 shadow-xl space-y-6">
      ...
      <section className="py-16 bg-slate-900 text-white text-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div>
            <button
              onClick={handleGetStarted}
              className="px-8 py-4 text-base font-bold text-slate-900 bg-white hover:bg-violet-100 rounded-2xl shadow-xl transition-all duration-200 inline-flex items-center gap-2 group"
            >
          ...
          <div className="text-xs text-slate-500 pt-4">
            InterviewAI • Grounded AI Interview Preparation • Powered by FastAPI & Gemini
          </div>
        </div>
      </section>
    </div>
